...
# see Config at https://github.com/openfga/openfga/blob/v1.8.9/internal/server/config/config.go#L260
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.8.9/internal/server/config/config.go#L612
