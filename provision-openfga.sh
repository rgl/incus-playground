...
# see Config at https://github.com/openfga/openfga/blob/v1.9.5/pkg/server/config/config.go#L293
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.9.5/pkg/server/config/config.go#L676
