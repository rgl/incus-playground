...
# see Config at https://github.com/openfga/openfga/blob/v1.15.0/pkg/server/config/config.go#L354
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.15.0/pkg/server/config/config.go#L807
