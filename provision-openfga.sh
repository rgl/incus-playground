...
# see Config at https://github.com/openfga/openfga/blob/v1.18.0/pkg/server/config/config.go#L366
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.18.0/pkg/server/config/config.go#L855
