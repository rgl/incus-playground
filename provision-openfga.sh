...
# see Config at https://github.com/openfga/openfga/blob/v1.8.7/internal/server/config/config.go#L252
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.8.7/internal/server/config/config.go#L604
