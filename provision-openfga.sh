...
# see Config at https://github.com/openfga/openfga/blob/v1.10.2/pkg/server/config/config.go#L300
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.10.2/pkg/server/config/config.go#L684
