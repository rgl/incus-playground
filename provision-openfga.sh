...
# see Config at https://github.com/openfga/openfga/blob/v1.6.2/internal/server/config/config.go#L210
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.6.2/internal/server/config/config.go#L522
