...
# see Config at https://github.com/openfga/openfga/blob/v1.5.5/internal/server/config/config.go#L204
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.5.5/internal/server/config/config.go#L495
