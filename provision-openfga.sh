...
# see Config at https://github.com/openfga/openfga/blob/v1.10.0/pkg/server/config/config.go#L302
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.10.0/pkg/server/config/config.go#L686
