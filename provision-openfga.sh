...
# see Config at https://github.com/openfga/openfga/blob/v1.11.6/pkg/server/config/config.go#L315
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.11.6/pkg/server/config/config.go#L700
