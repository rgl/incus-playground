...
# see Config at https://github.com/openfga/openfga/blob/v1.16.0/pkg/server/config/config.go#L363
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.16.0/pkg/server/config/config.go#L828
