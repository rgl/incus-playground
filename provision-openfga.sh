...
# see Config at https://github.com/openfga/openfga/blob/v1.11.2/pkg/server/config/config.go#L310
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.11.2/pkg/server/config/config.go#L687
