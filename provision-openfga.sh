...
# see Config at https://github.com/openfga/openfga/blob/v1.8.0/internal/server/config/config.go#L238
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.8.0/internal/server/config/config.go#L577
