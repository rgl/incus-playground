...
# see Config at https://github.com/openfga/openfga/blob/v1.9.2/pkg/server/config/config.go#L292
# see DefaultConfig at https://github.com/openfga/openfga/blob/v1.9.2/pkg/server/config/config.go#L675
